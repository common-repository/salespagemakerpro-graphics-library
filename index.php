...
<title>SalesPageMakerPro.com Graphics Library</title>
...
<div id="explorer">
    ...
    <div id="main">
        ...
        <div id="help" class="layer" style="display:none;">
            <h2>SalesPageMakerPro.com Graphics Library</h2>
            <a href="#" class="close" onclick="$.MediaBrowser.hideLayer(); return false;" title="<?php echo translate("Close")?>"><?php echo translate("Close")?></a>
            <hr />
            <div class="window">
				<div class="padding10">
	                <p>SalesPageMakerPro.com<br />
	                Url: http://www.SalesPageMakerPro.com</p>
	                <p>Help Files Goes Here</p>
	                <p>Help Files Goes Here</p>
	                <p>THelp Files Goes Here</p>
	                <p>Some of the other sites you may be interested in:</p>
	                <ul>
	                    <li>http://www.SalesPageHost.com - Build and host your sales pages for free.</li>
	                    <li>http://www.SalesPageMakerPro.com - Build professional sales pages easily</li>
	                    <li>http://www.Unlimitedhub.com</li>
	                   </ul>
...
<div id="file-specs">
	...
	?>
	<br>
	<iframe src ="http://salespagemakerpro.com/notice.html" width="60%" height="60%" align=middle frameborder=0 scrolling=no >
	</iframe>
    </div>
	
    <form id="fileform" name="fileform" onsubmit="$.MediaBrowser.insertFile(); return false;">
        <label for="file"><?php echo translate("File");?></label>
        <input type="text" name="file" id="file" readonly="readonly" value="" /><br><br>
		<label for="imageali">Image Alignment</label>
		<select name="imageal" id="imageal"> 
				<option value="aligncenter">Center</option> 
				<option value="alignleft">Left</option> 
				<option value="alignright">Right</option> 
				<option value="">None</option> 
				</select><br><br>
		<label for="alttext">Alt</label>
        <input type="text" name="alttext" id="alttext" value="" /><br>
		<br>
